...
<%
try{
	PreparedStatement ps = con.prepareStatement("select mini_proj.flat_users.flat_id, mini_proj.flat_users.fname, mini_proj.flat_users.phone_no from mini_proj.flat_users where flat_id=?");
