	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="../RegFlatUser"
					method="post">
					...
					<div class="wrap-input100 validate-input"
						...
						Email <input class="input100" type="email" name="email" required>
						<span class="focus-input100"></span>
					</div>
<br>
					<div>
						Flat No.  <select name="sel" id="soflow-color"><option value=""> Select Flat </option>
							<%
								Class.forName("com.mysql.cj.jdbc.Driver").newInstance();
								String connectionURL = "jdbc:mysql://localhost:3306/mini_proj";
								Connection connection = DriverManager.getConnection(connectionURL, "root", "root");
								PreparedStatement psmnt = connection.prepareStatement("select flat_details.flat_id,flat_details.sqft,flat_details.bhk from flat_details  where flat_details.flat_id not in (select flat_users.flat_id from flat_users)");
...
<br><br>
					<div class="wrap-input100 validate-input">
						Phone Number <input class="input100" type="text" name="phone_no" pattern="[6789][0-9]{9}"
