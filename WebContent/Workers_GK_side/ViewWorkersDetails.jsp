...
<body>
<h1 align="center">List of Workers Working</h1>
<div align="center">
...
String sql ="SELECT flat_users.flat_id, flat_users.Fname,workers.wname,  flat_users.phone_no FROM ((book_worker INNER JOIN flat_users ON book_worker.email = flat_users.email) INNER JOIN workers ON book_worker.w_id = workers.w_id);";
