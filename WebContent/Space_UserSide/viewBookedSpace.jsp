...
try{
	...
	PreparedStatement ps = con.prepareStatement("SELECT book_space.email, book_space.book_id,book_space.date,space.space_name FROM ((book_space INNER JOIN flat_users ON book_space.email = flat_users.email) INNER JOIN space ON book_space.space_id = space.space_id) where book_space.email=?");
...
<TD><%=rs.getString("book_space.email")%></TD>
