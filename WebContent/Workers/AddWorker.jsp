					...
					<div class="classy-menu">
						...
						<div class="classynav">
							<ul>
								...
								<li><a href="../Housing/ex.jsp">Payments</a></li>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="../RegWorker"
					method="post">
					...
					<div class="wrap-input100 validate-input">
						Worker Name <input class="input100" type="text" name="wname"
							required> <span class="focus-input100"></span>
					</div>

					<br>
					<div>
						Type     <select name="sel" id="soflow-color">Select worker<option
								value="">Select</option>
							<%
                                Class.forName("com.mysql.cj.jdbc.Driver").newInstance();
                                String connectionURL = "jdbc:mysql://localhost:3306/mini_proj";
                                Connection connection= DriverManager.getConnection(connectionURL, "root", "root");
                                PreparedStatement psmnt = connection.prepareStatement("select * from worker_type");
