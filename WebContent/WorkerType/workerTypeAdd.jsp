...
<!-- 	<h1>Registration Form</h1>
	<div class="ex">
		<form action="../WorkerType" method="post">
			<table style="with: 50%">
				<tr>
					<td></td>
					<td><input type="hidden" name="type_id" /></td>
				</tr>
				<tr>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form"
					action="../WorkerType" method="post">
					<span class="login100-form-title p-b-26"> Welcome to Housing
						Society </span> <span class="login100-form-title p-b-48"><h3>Add new Worker Category</h3> </span> <br> 
							
						
					<div class="">
						<input class="input100" type="hidden" name="type_id"> <span
							class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input">
						Woker Type: <input class="input100" type="text" name="type"> <span
							class="focus-input100"></span>
					</div>
