...
<body>
	<h1 align="center">Worker Type</h1>
	<style>
table {
	width: 100%;
}
...
String sql ="select * from worker_type";
...
<td><a href="UpdateFormWT.jsp?type_id=<%=rs.getString("type_id")%>"><button
						type="button" class="btn">Update</button></a></td>
<%-- <td><a href="deleteWT.jsp?type_id=<%=rs.getString("type_id") %>"><button
...
function myFunction() {
  ...
  if (r == true) {
    txt = "Confirm";
    window.location = "deleteWT.jsp?type_id=<%=rs.getString("type_id") %>";
				} else {
					txt = "No";
				}
