...
.btn1:hover {
	...
	<h1 align="center">Manage Service Providers</h1>
	<table id="t01">
		<tr>
		...
		<tr>
			...
			<td><a href="UpdateForm.jsp?sp_id=<%=rs.getString("sp_id")%>"><button
						type="button" class="btn">Update</button></a></td>
			<%-- <td><a href="deleteSP.jsp?sp_id=<%=rs.getString("sp_id")%>"><button
						type="button" class="btn1">Delete</button></a></td> --%>
						

<td><button type="button" onclick="myFunction()" class="btn1">Delete</button></a></td>
</tr>			
<script>
function myFunction() {
  var txt;
  ...
  if (r == true) {
    txt = "Confirm";
    window.location = "deleteSP.jsp?sp_id=<%=rs.getString("sp_id")%>";
  } else {
    txt = "No";
  }
