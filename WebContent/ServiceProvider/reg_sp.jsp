	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="../RegisterSp"
					method="post">
					<span class="login100-form-title p-b-26"> Welcome to Housing
						Society </span> <span class="login100-form-title p-b-48"><h3>Register
							Service Provider</h3> </span> <input type="hidden" name="sp_id" />
					<div class="wrap-input100 validate-input">
						Service provider name <input class="input100" type="text"
							name="sp_name" required> <span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input">
						Type <input class="input100" type="text" name="type" required>
