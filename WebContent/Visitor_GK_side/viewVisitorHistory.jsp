...
<body>
<h1 align="center">Previous Visitors History</h1>
<div align="center">
...
String sql ="SELECT v_id,flat_users.flat_id,name,comment,date,createdate status FROM flat_users INNER JOIN visitor_info ON flat_users.email = visitor_info.email where status<>'new'";
