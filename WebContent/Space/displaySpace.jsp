					...
					<div class="classy-menu">
						...
						<div class="classynav">
							<ul>
								...
								<li><a href='../Workers/AddWorker.jsp'>Add New Worker</a> <!-- <li><a href="serviceproviders.jsp">Services</a>
								...
								<li><a href="../Space/viewBookedSpace.jsp">Manage
										Bookings</a></li>
								<!-- <li><a href="blog.html">Blog</a></li>
...
<body>
	<h1 align="center">Manage Space</h1>
	<style>
table {
	width: 100%;
}
...
select#soflow-color {
	...
	<table id="t01">
		...
		<tr>
			...
			<TD><%=rs.getString("space_id")%></TD>
			<TD><%=rs.getString("space_name")%></TD>
			<TD><%=rs.getString("amount")%></TD>
			<TD><%=rs.getString("availability")%></TD>
			<td><a
				href="UpdateFormSpace.jsp?space_id=<%=rs.getString("space_id")%>"><button
						type="button" class="btn">Update</button></a></td>
			<%-- <td><a
				href="deleteSpace.jsp?space_id=<%=rs.getString("space_id")%>"><button
...
function myFunction() {
  ...
  if (r == true) {
    txt = "Confirm";
    window.location = "deleteSpace.jsp?space_id=<%=rs.getString("space_id")%>";
				} else {
					txt = "No";
				}
