...
String sql ="select * from complaints where status='new'";
...
<td><a href="complaintStatus.jsp?c_id=<%=rs.getString("c_id")%>"><button
						type="button" class="btn">Resolve</button></a></td>
</tr>
<%
i++;
}
